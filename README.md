...
```
pnpm wrangler deploy --name apihono-nest
```
...
```
pnpm wrangler d1 create HONESTDB
```
...
```
pnpm wrangler d1 execute HONESTDB --local --file=./drizzle/migrations/0000_familiar_rawhide_kid.sql
```
...
```
pnpm wrangler d1 execute HONESTDB --remote --file=./drizzle/migrations/0000_familiar_rawhide_kid.sql
```
